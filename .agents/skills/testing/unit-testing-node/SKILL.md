...
description: "Écrire et exécuter des tests unitaires pour les fonctions et modules Node.js."
risk: safe
---
...
## Instructions
1. Choisissez un framework de test (Jest, Vitest) et configurez-le dans votre projet Node.js.
