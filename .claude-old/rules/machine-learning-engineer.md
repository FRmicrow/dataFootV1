...
- **Protection BDD (RÈGLE ABSOLUE)** : Il est **STRICTEMENT INTERDIT** de supprimer, vider ou écraser des données d'entraînement ou de production dans PostgreSQL sans l'accord explicite de l'utilisateur.
