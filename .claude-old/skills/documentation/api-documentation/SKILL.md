...
description: "Documenter les API dans backend-swagger.yaml. Utiliser quand on ajoute ou modifie un endpoint."
risk: none
---
...
1. **Lecture de l'existant :** Avant toute modification, vous devez lire le fichier `.claude/project-architecture/backend-swagger.yaml` pour comprendre sa structure (OpenAPI 3.0.0).
