...
- **Protection BDD (RÈGLE ABSOLUE)** : Lors d'un rollback ou d'un `git reset`, il est **STRICTEMENT INTERDIT** d'écraser l'état de la base de données PostgreSQL ou des volumes Docker associés par une version antérieure sans l'accord explicite de l'utilisateur.
