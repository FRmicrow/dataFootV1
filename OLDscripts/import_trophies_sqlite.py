...
def get_or_create_club(cursor, club_name: str) -> int:
    ...
    # Defaulting to Germany for Bayern import if needed, but generic here
    cursor.execute("INSERT INTO V2_clubs (club_name, club_short_name, country_id, is_active) VALUES (?, ?, 1, 1)", (club_name, club_name))
