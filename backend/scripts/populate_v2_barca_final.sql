...
-- Populate script used 'CI' for Ivory Coast and 'ML' for Mali. BUT I checked and inserted with 'CI'/'ML'. 
-- BUT maybe they were not inserted because I only inserted 45 countries in the full script?
-- I will use a fallback to look up by name if code fails, or just insert them if missing.
-- Let's assume they are missing and insert them first with IGNORE.

INSERT OR IGNORE INTO V2_countries (country_name, country_code, continent) VALUES ('Ivory Coast', 'CI', 'Africa');
INSERT OR IGNORE INTO V2_countries (country_name, country_code, continent) VALUES ('Mali', 'ML', 'Africa');
INSERT OR IGNORE INTO V2_countries (country_name, country_code, continent) VALUES ('Cameroon', 'CM', 'Africa');
...
-- 4. Club Trophies
-- Using INSERT OR IGNORE to avoid unique constraint violations on re-runs
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='La Liga'), '2004-05', 2005, 0, 'Rijkaard era');
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='La Liga'), '2005-06', 2006, 0, 'Ronaldinho');
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='La Liga'), '2008-09', 2009, 0, 'Treble');
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='La Liga'), '2009-10', 2010, 0, NULL);
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='La Liga'), '2010-11', 2011, 0, NULL);
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='La Liga'), '2012-13', 2013, 0, '100 points');
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='La Liga'), '2014-15', 2015, 0, 'Treble');
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='La Liga'), '2015-16', 2016, 0, NULL);
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='La Liga'), '2017-18', 2018, 0, NULL);
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='La Liga'), '2018-19', 2019, 0, NULL);
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='La Liga'), '2022-23', 2023, 0, 'Xavi');

INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='UCL'), '2005-06', 2006, 0, 'Paris');
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='UCL'), '2008-09', 2009, 0, 'Rome');
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='UCL'), '2010-11', 2011, 0, 'Wembley');
INSERT OR IGNORE INTO V2_club_trophies (club_id, competition_id, season, year, is_runner_up, notes) VALUES ((SELECT club_id FROM V2_clubs WHERE club_name='FC Barcelona'), (SELECT competition_id FROM V2_competitions WHERE competition_short_name='UCL'), '2014-15', 2015, 0, 'Berlin');
