export const up = async (db) => {
    ...
    await db.run(`CREATE TABLE IF NOT EXISTS V3_Odds_Selections (
    ...
    try {
        await db.run("ALTER TABLE V3_Fixtures ADD COLUMN odds_last_sync TIMESTAMPTZ");
    ...
    await db.run('CREATE INDEX IF NOT EXISTS idx_v3_odds_fixture_id ON V3_Odds_Selections(fixture_id)');
    await db.run('CREATE INDEX IF NOT EXISTS idx_v3_odds_market ON V3_Odds_Selections(market_name)');
};
