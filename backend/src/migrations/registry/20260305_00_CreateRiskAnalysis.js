export const up = async (db) => {
    ...
    db.run(`CREATE TABLE IF NOT EXISTS V3_Risk_Analysis (
    ...
    db.run('CREATE INDEX IF NOT EXISTS idx_risk_analysis_fixture ON V3_Risk_Analysis(fixture_id)');
    db.run('CREATE INDEX IF NOT EXISTS idx_risk_analysis_market ON V3_Risk_Analysis(market_type)');
};
