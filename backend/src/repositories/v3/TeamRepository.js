...
class TeamRepository extends BaseRepository {
    ...
    async getTeamProfileWithVenue(id) {
    ...
    async getTeamTacticalSummary(teamId, options = {}) {
    ...
    async getTeamSummary(teamId, year = null, leagueId = null) {
        let sql = `
            SELECT 
    ...
    async getTeamRoster(teamId, year, leagueId = null) {
        let sql = `
            SELECT 
