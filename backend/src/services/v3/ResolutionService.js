...
export class ResolutionService {
     ...
     */
    static calculateConfidence(player1, player2) {
        ...
        const historyOverlap = this.checkTeamHistoryOverlap(player1.player_id, player2.player_id);
        if (historyOverlap) {
            score += 20;
        }
     ...
     */
    static checkTeamHistoryOverlap(id1, id2) {
     ...
     */
    static performMerge(id1, id2) {
        const { masterId, ghostId } = this.identifyMaster(id1, id2);
     ...
     */
    static findGlobalDuplicates(threshold = 80) {
        ...
        for (const pair of pairs) {
            ...
            const confidence = this.calculateConfidence(p1, p2);
