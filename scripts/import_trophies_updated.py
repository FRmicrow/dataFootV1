...
COMPETITION_MAPPINGS = {
    ...
    'Second Division / Championship': 'EFL Championship',
    'Championnat d’Angleterre de deuxième division / Championship': 'EFL Championship',
    'Second Division (championnat niveau 2)': 'EFL Championship',
    'English Second Division / EFL Championship (Champions)': 'EFL Championship',
    'English Second Division / Championship (championnat niveau 2)': 'EFL Championship',
    'Championship / Division Two (niveau 2)': 'EFL Championship',
    'Championship / Second Division': 'EFL Championship',
